                        ...
                        <div class="col-lg-6">
                            <div class="p-5" style="margin-top: initial;">
                                <div class="text-center">
                                    <h4 class="text-dark mb-4" style="color: rgb(135, 135, 150); margin-bottom: 24px; margin-top: 5px;">Admin Register Page</h4>
                                </div>
                                <form class="user" action="{{ route('admin.register') }}" method="POST" style="margin-top: 0px; margin-bottom: 0px; padding-top: 3px;">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route('admin.login') }}" style="color: navy;">Already have an account? Login</a>
                                    </div>
                                    <div class="text-center">
