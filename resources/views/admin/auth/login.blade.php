                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex">
                            <div class="flex-grow-1 bg-login-image" style="background-image: url{{ ('/avatars/clipboard-image.png') }}">
                                <img src="{{ asset('img/adminlogin.png') }}" style="margin-right: 0PX;margin-left: 31px;width: 480PX;margin-bottom: 0PX;margin-top: 2px;padding-right: 7PX;">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5" style="margin-top: initial;">
                                <div class="text-center">
                                    <h4 class="text-dark mb-4" style="color: rgb(135, 135, 150);margin-bottom: 24px;margin-top: 5px;">Admin</h4>
                                </div>
                                <form class="user" action="{{ route('admin.login') }}" method="POST" style="margin-top: 0px;margin-bottom: 0px;padding-top: 3px;">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('admin.register') }}" style="color: navy;">Create New Account</a>
                                    </div>
                                </form>
                            </div>
                        </div>
